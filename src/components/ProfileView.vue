...
<template>
  <div class="dashboard">
      ...
      <div class="profile-header">
          <div v-if="state.userProfile" class="user-info">
              ...
              <div class="user-text">
                  ...
                  <span class="member-since" v-if="stats.memberSince !== 'Unknown'">Member since {{ stats.memberSince }} ({{ stats.accountAge }} Years)</span>
      ...
      <div class="viz-grid">
          ...
          <div class="viz-card">
              <h3>Backlog Ratio</h3>
              <div class="donut-chart" :style="{ background: `conic-gradient(#ff5252 0% ${(stats.unplayed/stats.totalGames)*100}%, #66c0f4 ${(stats.unplayed/stats.totalGames)*100}% ${((stats.unplayed+stats.played)/stats.totalGames)*100}%, #ffc83d ${((stats.unplayed+stats.played)/stats.totalGames)*100}% 100%)` }">
          ...
          <div class="list-card">
              ...
              <div class="simple-list">
                  <div v-for="game in stats.recent" :key="game.appid" class="list-row">
                      <img :src="`http://media.steampowered.com/steamcommunity/public/images/apps/${game.appid}/${game.img_icon_url}.jpg`" class="icon"/>
