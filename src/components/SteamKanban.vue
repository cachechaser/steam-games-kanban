	...
	<div class="steam-kanban">
		<div class="controls">
			...
			<p class="info" v-if="!apiKey">
				Note: Even with Steam Login, you need a Steam Web API Key from <a href="https://steamcommunity.com/dev/apikey"
						...
						<div class="stats">
							<div v-if="game.achievements && !game.achievements.error">
								...
								<div class="progress-bar">
									<div class="progress"
									     :style="{ width: (game.achievements.achieved / game.achievements.total * 100) + '%' }"></div>
								</div>
							</div>
