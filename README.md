...
## AI Usage Disclaimer
This project was built with the help of AI tools, specifically GitHub Copilot (different models) and Gemini 3 Pro.
I used these tools to generate boilerplate and rough feature code, documentation/comments and bulk refactoring tasks.